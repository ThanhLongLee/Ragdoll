...
namespace Unity.Common.Helper
{
    public static class StringHelper
    {
        ...
        public static string FormatCurrency(decimal value, string format, string strCountry = "en-EN")
        {
        ...
        public static string ToImageUrl(this string fileName, string folder)
        {
            if (string.IsNullOrEmpty(fileName))
                return AppSettings.ImageHosting + "Common/" + "no-image.jpg";


            // get full path by folder target
            var fullPath = FileHelper.ResourcesPath(folder);

            // target folder save file
            var destinationFile = fullPath + fileName;

            // If file not Exists then return no-image.jpg
            if (!System.IO.File.Exists(destinationFile))
                return AppSettings.ImageHosting + "Common/" + "no-image.jpg";

            return AppSettings.ImageHosting + folder + fileName;
        }
    }
